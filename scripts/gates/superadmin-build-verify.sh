#!/bin/bash
# GCP-STG-0711: SuperAdmin build output verification
set -e
echo "=== SUPERADMIN BUILD OUTPUT CHECK ==="

DIST="supermandi-superadmin/dist"
...
if [ "$MAPS" -gt 0 ]; then
  echo "WARNING: $MAPS source map files found in dist/"
fi
...
echo "=== SUPERADMIN BUILD OUTPUT: PASS ==="
