...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
      <div className="text-7xl font-extrabold text-slate-200 dark:text-slate-700">404</div>
      <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100 mt-4 mb-2">Page Not Found</h1>
