...
describe("STG-562: CompareScreenV3", () => {
  test("shows multiple supplier offers ranked", () => {
  ...
  test("shows MOQ, delivery, BNPL, credit terms per supplier", () => {
    const src = fs.readFileSync(path.resolve(__dirname, "../../screens/v3/CompareScreenV3.tsx"), "utf8");
  ...
  test("calculates margin and total for weekly need", () => {
    const src = fs.readFileSync(path.resolve(__dirname, "../../screens/v3/CompareScreenV3.tsx"), "utf8");
  ...
  test("shows current stock and sell price context", () => {
    const src = fs.readFileSync(path.resolve(__dirname, "../../screens/v3/CompareScreenV3.tsx"), "utf8");
  ...
  test("has order button per supplier", () => {
    const src = fs.readFileSync(path.resolve(__dirname, "../../screens/v3/CompareScreenV3.tsx"), "utf8");
