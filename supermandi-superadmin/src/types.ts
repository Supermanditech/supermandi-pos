...
export type TabKey = "events" | "devices" | "stores" | "suppliers" | "payments" | "analytics" | "ai-insights" | "users" | "settings" | "audit" | "documents" | "registrations" | "staff" | "grn-alerts" | "applications" | "invoices" | "gst-compliance" | "refunds" | "monitoring" | "quality" | "credit-providers" | "support" | "whatsapp" | "maintenance" | "store-health" | "compliance" | "catalog" | "demand-pressure" | "allocations" | "settlements";
...
// R3-FMT-003: Case-insensitive — UPI VPAs accept uppercase input
export const UPI_VPA_PATTERN = /^[a-z0-9._-]{3,}@[a-z0-9]{2,}$/i;
