...
| HEAD | `44270c16` |
| Branch | `main` |
| Origin sync | `44270c16` (pushed, 0 ahead) |
| Working tree | Clean |
| CI run | `22492025902` (20/20 gates green) |
| workflow:validate | PASS (tickets=1252) |
| Last GCP deploy | `badc3fbe` (2026-02-23, run 22305359033) |
| Commits since deploy | 247 |
...
gh run view 22492025902 --repo Supermanditech/supermandi-pos
